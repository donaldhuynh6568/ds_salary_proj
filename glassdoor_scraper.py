...
def get_jobs(keyword, num_jobs, verbose, path, slp_time):
    ...
    while len(jobs) < num_jobs:  #If true, should be still looking for new jobs.
        ...
        try:
            driver.find_element_by_class_name('d-flex.justify-content-between.align-items-start').click()
        ...
        for job_button in job_buttons:  
            ...
            try:
                driver.find_element_by_xpath('//*[@id="JobContent"]//header/ul/li[2]/span').click()


                try:
                    size = driver.find_element_by_xpath('//*[@id="EmpBasicInfo"]/div[1]/div/div[1]/span[1]//following-sibling::[1]').text
                except NoSuchElementException:
                    size = -1

                try:
                    founded = driver.find_element_by_xpath('//*[@id="EmpBasicInfo"]/div[1]/div/div[2]/span[1]//following-sibling::[1]').text
                except NoSuchElementException:
                    founded = -1

                try:
                    type_of_ownership = driver.find_element_by_xpath('//div[@class="d-flex.justify-content-start.css-rmzuhb.e1pvx6aw0"]//span[text()="Type"]//following-sibling::[2]').text
                except NoSuchElementException:
                    type_of_ownership = -1
